...
5. Confirming launches the mission, moves the UI to Mission, selects the bbox, opens Visual Evidence Tools, and starts the live scan loop.
...
5. Verify Mission becomes active, the map selects the compact review bbox, Visual Evidence Tools open, and the target chips list debris/slick/foam candidates.
6. Wait for Mission Pass Complete.
7. Click `Run All` under Mission Targets and verify candidate grounding result chips render.
