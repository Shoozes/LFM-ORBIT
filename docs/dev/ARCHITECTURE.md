...
- Latest checked model revision: `2a8c57cbb7f4dda26d5faff2ec3e31a5cbd2f4b8`, task `wildfire_detection`, `training_modality=image_text`, `image_training_verified=true`, `5670` train rows, `6758` image blocks, and `630` eval rows.
