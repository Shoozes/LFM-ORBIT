...
- `.\run.ps1 -Verify` passed end to end on May 5, 2026: backend `460 passed`, trained GGUF smoke passed, frontend lint/build passed, and Playwright passed `97` with `6` intentional skips for HTML dump and retired visual-overlay UI specs.
