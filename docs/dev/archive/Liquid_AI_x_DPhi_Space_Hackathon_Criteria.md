...
The solution addresses a real problem that benefits specifically from running AI models on the satellite rather than on the ground.
...
| :---- | :---- |
| **Cash Prize $5’000 Credits for Software Execution in Space** 5 GPU hours (NVIDIA Orin 16GB) 5MB of data upload to satellite 10MB of data download from satellite 1GB of in-space storage for 1 month All historic images of fisheye camera on the satellite. Access to all public Docker images and LLMs preloaded on the satellite. 7 days of testing on the satellite ground compute server**.** |  **Credits for Software Execution in Space** 5 GPU hours (NVIDIA Orin 16GB) 5MB of data upload to satellite 10MB of data download from satellite 1GB of in-space storage for 1 month All historic images of fisheye camera on the satellite. Access to all public Docker images and LLMs preloaded on the satellite. 7 days of testing on the satellite ground compute server**.** |
