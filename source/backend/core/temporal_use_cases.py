...
_TEMPORAL_USE_CASES: list[dict[str, Any]] = [
    ...
    {
        "id": "ice_snow_extent",
        "display_name": "Long-window ice and snow extent monitoring",
        "target_task": "ice_snow_extent_monitoring",
        "target_category": "cryosphere",
        "default_target_action": "review",
        "temporal_methods": [
            "Sentinel-2 L2A NDSI trend scoring",
            "SCL cloud, shadow, no-data, and snow/ice support checks",
            "NDWI/SWIR water-ice ambiguity review",
            "multi-frame snow/ice persistence before any extent-change label",
            "seasonal-window warning when baseline and current months do not align",
        ],
        "signals": [
            "ndsi_increase",
            "ndsi_decrease",
            "snow_ice_scl_support",
            "cloud_rejected",
            "multi_frame_persistence",
            "water_ice_ambiguity",
            "seasonal_window_warning",
        ],
        "keywords": [
            "ice snow extent",
            "snow ice extent",
        ...
        "examples": [
            {
                "name": "Greenland edge snow/ice persistence",
                "task_text": "Review Greenland edge snow and ice extent using NDSI, SCL cloud rejection, and multi-frame persistence.",
                "bbox": [-51.13, 69.1, -50.97, 69.26],
                "start_date": "2024-01",
                "end_date": "2025-12",
                "expected_signal": "Accepted Sentinel-2 L2A frames show NDSI-supported snow/ice ratio change with clouds rejected before scoring.",
                "training_label": {"target_action": "review", "target_category": "cryosphere"},
            },
            {
                "name": "Cloud/snow confusion control",
                "task_text": "Reject a bright visible frame as snow evidence when SWIR and SCL indicate cloud or shadow contamination.",
                "bbox": [-46.2, 65.3, -45.8, 65.7],
                "start_date": "2025-04",
                "end_date": "2025-06",
                "expected_signal": "Bright RGB alone is insufficient; cloud SCL classes and weak NDSI force a defer/review outcome.",
                "training_label": {"target_action": "defer", "target_category": "none"},
            },
        ],
    },
    {
        "id": "ice_cap_growth",
        "display_name": "Legacy ice cap, glacier, and sea-ice visual review",
    ...
    },
    {
        ...
        "display_name": "Harmful algal bloom and water-quality candidate monitoring",
        "target_task": "harmful_algal_bloom_monitoring",
        "target_category": "water_quality",
        "default_target_action": "review",
        "temporal_methods": [
            "Sentinel-2 L2A water mask and cloud/shadow rejection",
            "NDCI chlorophyll/cyanobacteria-like signal review",
            "FAI surface bloom or scum candidate screening",
            "turbidity and glint control review",
            "NOAA/FDEP/field confirmation before toxicity or species claims",
        ],
        "signals": [
            "high_ndci",
        ...
        "examples": [
            {
                "name": "Lake Okeechobee bloom candidate",
                "task_text": "Check Lake Okeechobee for probable algal bloom or cyanobacteria-like surface signals.",
                "bbox": [-81.16, 26.64, -80.55, 27.24],
                "start_date": "2026-04",
                "end_date": "2026-05",
                "expected_signal": "Water pixels pass cloud/shadow gates and show elevated NDCI or FAI; output stays probable bloom evidence until NOAA/FDEP or field confirmation.",
                "training_label": {"target_action": "review", "target_category": "water_quality"},
            },
            {
                "name": "Red tide cautious coastal review",
                "task_text": "Review Florida coastal water for possible red tide or high-chlorophyll signal without confirming Karenia brevis.",
                "bbox": [-82.92, 26.6, -82.4, 27.15],
                "start_date": "2026-03",
                "end_date": "2026-05",
                "expected_signal": "Coastal color or chlorophyll anomaly remains candidate HAB evidence and needs NOAA forecast or field cell-count support.",
                "training_label": {"target_action": "review", "target_category": "water_quality"},
            },
        ],
    },
    ...
    {
        "id": "mining_expansion",
        "display_name": "Critical minerals expansion watch",
        "target_task": "mining_temporal_detection",
        "target_category": "mining",
        "default_target_action": "review",
        "temporal_methods": [
            "historical-to-current extraction footprint comparison",
            "bare-earth expansion comparison",
            "evaporation pond color and extent tracking",
            "tailings pond shape tracking",
            "industrial road and facility growth review",
            "vegetation-to-exposed-ground transition detection",
        ],
        "signals": [
            "bare_ground_expansion",
            "evaporation_pond_change",
            "tailings_change",
            "excavation_growth",
            "industrial_road_growth",
            "facility_cluster_growth",
            "surface_color_change",
            "soil_exposure_spike",
        ],
        "keywords": [
            "critical minerals",
        ...
        "examples": [
            {
                "name": "Critical Minerals Expansion Watch",
                "task_text": "Run Critical Minerals Expansion Watch over the Salar de Atacama / Escondida / Atacama mining corridor. Compare historical and current satellite imagery for evaporation pond regions, tailings regions, open-pit expansion, industrial roads, facility clusters, exposed soil, and surface color change.",
                "bbox": [-69.115, -24.29, -69.035, -24.21],
                "start_date": "2024-01",
                "end_date": "2025-12",
                "expected_signal": "Persistent extraction-site regions, pond-like/tailings-like surfaces, roads, and facility clusters change across the temporal sequence without claiming illegal activity, pollution, or production output.",
                "training_label": {"target_action": "review", "target_category": "mining"},
            }
        ],
    },
    {
...
def build_training_jsonl_row(record: dict[str, Any]) -> dict[str, Any]:
    ...
    context = {
        ...
        "lng": record.get("lng"),
        "target_pack_id": record.get("target_pack_id"),
        "object_targets": record.get("object_targets", []),
        "object_target_labels": record.get("object_target_labels", []),
        ...
        "runtime_truth_mode": record.get("runtime_truth_mode", ""),
        "imagery_origin": record.get("imagery_origin", ""),
        "scoring_basis": record.get("scoring_basis", ""),
        ...
        "visual_model_review": record.get("visual_model_review"),
        "visual_model_response": record.get("visual_model_response", ""),
        "visual_model_backend": record.get("visual_model_backend", ""),
        "review_status": record.get("review_status", ""),
